...
const getGenreString = (genre) => {
  ...
  if (Array.isArray(genre))
    return genre.map((g) => (typeof g === "object" ? g.name : g)).join(", ");
...
export default function UserDashboard() {
  ...
  return (
    <div
      style={{ paddingTop: 10, minHeight: "100vh", background: "transparent" }}
    >
      {toast && (
        <Toast
      ...
      >
        <div className="container">
          ...
          <p className="mb-0" style={{ opacity: 0.8 }}>
            Manage your library activity below.
          </p>
        </div>
      </div>
            ...
            {recLoading ? (
              ...
              >
                ...
                <p style={{ marginTop: 8, fontSize: "0.88rem" }}>
                  No recommendations yet — borrow some books to get personalized
                  suggestions!
                </p>
              </div>
            ) : (
